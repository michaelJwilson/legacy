...
def Convolve(model, _psf_fwhm, pixel_scale=0.263, nx=90, ny=90, shear=False, position_angle=0.0, psf_ell=0.0):
  if _psf_fwhm > 0.0:
...
def gen_exponential(_gal_flux, _gal_hlight, _psf_fwhm=0.0, sky_level_pixel=0.0, pixel_scale=0.263, nx=90, ny=90, shear=False, position_angle=0.0, psf_ell=0.0):
...
def fit_rexmodel(_image, _ivar, psf_fwhm, disp=False, x0=np.array([3.5e3, 0.2])):
  m      = Minuit(_fit_rexmodel, x0[0], x0[1])
